...
if __name__ == "__main__":
    ...
    for model_name in models:
        ...
        torch.save(model.state_dict(), f"quantized_{model_name}.pt")
        ...
        model_parameter_counts[model_name] = num_params
        ...
        with torch.no_grad():
            ...
            t = {"mean time": np.mean(times), "stddev": np.std(times)}

            model_times[model_name] = t
        """
